...
public class Shadows {
    ...
    public Vector4 ReserveDirectionalShadows(Light light, int visibleLightIndex)
    {
        if (ShadowedDirectionalLightCount < maxShadowedDirectionalLightCount &&
            ...
            //check whether useShadowMask or not
            float maskChannel = -1;
    ...
    Matrix4x4 ConvertToAtlasMatrix (Matrix4x4 m, Vector2 offset, int split) {
        ...
        //LightClipVP * fragPosWS
        //then transfer from [-1,1] to [0,1] space
        //then scale to split, and move to split offset
    ...
    public void Render()
    {
        ...
        //以下代码从RenderDirectionalShadows中转移到Render函数的此处
        //即使没有cascade directional shadow，仍然需要shadow distance fade的相关信息
    ...
    void RenderDirectionalShadows()
    {
        ...
        for (int i = 0; i < ShadowedDirectionalLightCount; i++) {
            ...
            RenderCascadeDirectionalShadow(i, split, tileSize);
        }
    ...
    void RenderCascadeDirectionalShadow(int index, int split, int tileSize)
    {
        ShadowedDirectionalLight light = shadowedDirectionalLights[index];
        var shadowSettings =
        ...
        for (int i = 0; i < cascadeCount; i++) {
            ...
            //only need to calculate cascade culling sphere
            //for the first light
    ...
    void RenderSpotShadows (int index, int split, int tileSize) {
        ...
        float tileSclae = 1f / split;
        SetOtherTileData(index, offset, tileSclae, bias);
    ...
    void RenderPointShadows (int index, int split, int tileSize) {
        ...
        for (int i = 0; i < 6; ++i)
        {
            ...
            SetOtherTileData(tileIndex, offset, tileSclae, bias);
